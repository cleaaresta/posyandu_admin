        ...
        <div class="w-full max-w-full px-3 shrink-0 md:w-8/12 md:flex-0">
            <div
                ...
                <div class="flex-auto p-6">
                    ...
                    <form action="{{ route('jadwal-posyandu.update', $jadwal->jadwal_id) }}" method="POST"
                        ...
                        <div class="mb-4">
                            <label
                                class="inline-block mb-2 ml-1 text-xs font-bold text-slate-700 dark:text-white/80">Posyandu</label>
                            <div class="relative">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="tanggal"
                                ...
                                class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 px-3 py-2" />
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="keterangan" rows="3"
                                class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 px-3 py-2">{{ old('keterangan', $jadwal->keterangan) }}</textarea>
                        </div>
