            ...
            <div
                ...
                <div class="flex-auto p-6">
                    ...
                    <form action="{{ route('user.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <label for="password" class="inline-block mb-2 ml-1 text-xs font-bold text-slate-700 dark:text-white/80">Password Baru (Opsional)</label>
                        ...
                        <div class="mb-4">
                            <label for="password_confirmation" class="inline-block mb-2 ml-1 text-xs font-bold text-slate-700 dark:text-white/80">Konfirmasi Password Baru</label>
